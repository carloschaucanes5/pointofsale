            ...
            <form action="{{route('income.store')}}" method="POST" class="form">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="product_id" id="product_id" class="form-control selectpicker" data-live-search="true">
                                    ...
                                    <option data-tokens="{{$pro->id}}">{{$pro->article}}</option>   
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="btn_add">Acción</label>
                    ...
                    <div class="row">
                        <div class="col-md-12 table-responsive">
                            <table class="table table-hover mb-1" id="detalles">
                                <thead >
                                    <tr style="background-color: #A9D0FS">
                                        <th>Opciones</th>
                                        <th>Producto</th>
                                        <th>Cantidad</th>
                                        <th>Precio Compra</th>
...
@push("scripts")
    <script>
        ...
        function add(){
            dataArticle = document.getElementById('product_id').value.split('_');
            ...
            if(product_id!="" && quantity!="" && quantity > 0 && purchase_price !="" && sale_price!=""){
                ...
                <tr class="selected" id="fila`+cont+`">
                    ...
                    <td><input type="number" name="quantities[]" value="`+quantity+`"></td>
                    <td><input type="number" name="purchase_prices[]" value="`+purchase_price+`"></td>
                    <td><input type="number" name="sale_prices[]" value="`+sale_price+`"></td>
                    <td>`+subtotal[cont]+`</td>
                </tr>
                `;
                cont++;
